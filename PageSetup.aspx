<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PageSetup.aspx.cs" Inherits="PageSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="divFormHeader" class="divclsInput" style="position:absolute; left:5px; top:5px; height:137px; width:613px;">
        ...
        <hr style="position:absolute; top:27px;  width:612px; left:0px; color:#57677F;" />  
         ...
         <asp:Label ID="lblPageName"  runat="server" CssClass="labelTextField" Text="Page Name"  style="position:absolute; top:63px; left:140px;"  ></asp:Label>
         <asp:TextBox ID="txtPageName" runat="server" CssClass="textBox" style="position:absolute; top:60px; left:240px;" ></asp:TextBox>

          <asp:Button id="btnSave" CssClass="Submitbutton" runat="server" Text="Save" 
            style="position:absolute; top:100px; left:345px; height:30px;" 
    ...
    <div id="grdFrm" class="divclsInput" style="position:absolute; left:5px; top:5px; height:248px; width:613px; overflow:auto; "  >
        ...
        <asp:GridView ID="grdPageSetup" DataKeyNames="PageId" runat="server"  AutoGenerateColumns="false" 
                ...
                onrowcreated="grdPageSetup_RowCreated" 
                onpageindexchanging="grdPageSetup_PageIndexChanging" 
                onrowdatabound="grdPageSetup_RowDataBound" 
                onrowdeleting="grdPageSetup_RowDeleting" 
                onselectedindexchanging="grdPageSetup_SelectedIndexChanging" >                  
               ...
               <Columns>
                        ...
                        <asp:TemplateField HeaderText=""  ItemStyle-Width="50px" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1" ItemStyle-BorderColor="Gray">
                            ...
                            <ItemTemplate> 
                                ...
                                <asp:LinkButton ID="LinkButtonDelete"  CommandArgument='<%# Eval("PageId") %>' CommandName="Delete" runat="server" Text="Delete" ></asp:LinkButton>                                                            
                            </ItemTemplate>
                        </asp:TemplateField>

...
Begin VB.Form FrmAreaFinder 
   ...
   End
End
Attribute VB_Name = "FrmAreaFinder"
...
Private Sub comdselect_Click()
  If cnt = 1 Then  '1
            FrmBengolyCirChallan.TbAreaFrom.Text = Trim(DataGrid1.Columns(0).Text)
        End If
        If cnt = 1 Then  '2
            FrmBengolyCirChallan.TxtAreaFrom.Text = Trim(DataGrid1.Columns(1).Text)
        End If


        If cnt = 2 Then  '1
            FrmBengolyCirChallan.TbAreaTo.Text = Trim(DataGrid1.Columns(0).Text)
        End If
        If cnt = 2 Then  '2
            FrmBengolyCirChallan.TxtAreaTo.Text = Trim(DataGrid1.Columns(1).Text)
        End If
...
'Me.WindowState = 0
 ...
 cmdfindnow.Enabled = False
  ...
  Set rs = Get_RS("SELECT * FROM F13_AreaFinder")
  Set DataGrid1.DataSource = rs
    FrmAreaFinder.DataGrid1.Columns(0).Width = 1000
    FrmAreaFinder.DataGrid1.Columns(1).Width = 2500
    FrmAreaFinder.DataGrid1.Columns(0).Caption = "Area ID"
    FrmAreaFinder.DataGrid1.Columns(1).Caption = "Area Name"
...
Dim rs As New ADODB.Recordset
 ...
 If combofindby.Text = "Area ID" And Combo1.Text = "Starts With" Then

        .Open "select * from DBO.F13_AreaFinder" _
            & " where [Division ID] like '" & Trim(tbfilter) & "%" & "' "

         ' [Query For AreaCat Name]

ElseIf combofindby.Text = "Area Name" And Combo1.Text = "Starts With" Then
        .Open "select * from DBO.F13_AreaFinder" _
  ...
  ' [Query For AreaCat ID]

 ElseIf combofindby.Text = "Area ID" And Combo1.Text = "Contents" Then
...
ElseIf combofindby.Text = "Area Name" And Combo1.Text = "Contents" Then
        .Open "select * from DBO.F13_AreaFinder" _
            & " WHERE [Division Name] like '%" & Trim(tbfilter) & "%" & "' "

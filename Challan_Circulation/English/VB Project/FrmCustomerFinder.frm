...
Begin VB.Form FrmCustomerFinder 
   Caption         =   " Finder - Invoiced Customer Finder"
   ClientHeight    =   7095
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7110
   Icon            =   "FrmCustomerFinder.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   7095
   ScaleWidth      =   7110
   ...
   End
End
Attribute VB_Name = "FrmCustomerFinder"
...
Private Sub DataGrid1_DblClick()
      ...
      If cnt = 1 Then  '1
           FrmChallanEng.TbCustTypeFrom.Text = Trim(DataGrid1.Columns(0).Text)
      End If

        If cnt = 2 Then  '1
            FrmChallanEng.TbCustTypeTo.Text = Trim(DataGrid1.Columns(0).Text)
        End If
...
'Me.WindowState = 0
 ...
 cmdfindnow.Enabled = False
  ...
  Set rs = Get_RS("SELECT * FROM F03_CustomerFinder")
...
Dim rs As New ADODB.Recordset
 ...
 If combofindby.Text = "Customer ID" And Combo1.Text = "Starts With" Then

        .Open "select * from DBO.F03_CustomerFinder" _
            & " where [Customer ID] like '" & Trim(tbfilter) & "%" & "' "

         ' [Query For CustomerCat Name]

ElseIf combofindby.Text = "Customer Name" And Combo1.Text = "Starts With" Then
        .Open "select * from DBO.F03_CustomerFinder" _
            & " WHERE [Customer Name] like '" & Trim(tbfilter) & "%" & "' "
 ...
 ElseIf combofindby.Text = "Customer ID" And Combo1.Text = "Contents" Then
...
ElseIf combofindby.Text = "Customer Name" And Combo1.Text = "Contents" Then
        .Open "select * from DBO.F03_CustomerFinder" _
            & " WHERE [Customer Name] like '%" & Trim(tbfilter) & "%" & "' "

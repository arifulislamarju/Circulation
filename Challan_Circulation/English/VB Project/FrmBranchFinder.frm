...
Begin VB.Form FrmCustomerCatFinder 
   Caption         =   "Finder - Customer Category"
   ClientHeight    =   7050
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6990
   Icon            =   "FrmBranchFinder.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7050
   ScaleWidth      =   6990
   ...
   End
End
Attribute VB_Name = "FrmCustomerCatFinder"
...
Private Sub cmdselect_Click()
        ...
        If cnt = 1 Then  '1
            FrmCustWiseSalesSumm.TxtBranchFrom.Text = Trim(DataGrid1.Columns(0).Text)
        End If
        If cnt = 1 Then  '2
            FrmCustWiseSalesSumm.TxtBranchNameFrom.Text = Trim(DataGrid1.Columns(1).Text)
        End If


        If cnt = 2 Then  '1
            FrmCustWiseSalesSumm.TxtBranchTo.Text = Trim(DataGrid1.Columns(0).Text)
        End If
        If cnt = 2 Then  '2
            FrmCustWiseSalesSumm.TxtBranchNameTo.Text = Trim(DataGrid1.Columns(1).Text)
        End If
...
Private Sub DataGrid1_DblClick()
        ...
        If cnt = 1 Then  '1
            FrmCashSalesState.TbCustTypeFrom.Text = Trim(DataGrid1.Columns(0).Text)
        End If
        If cnt = 1 Then  '2
            FrmCashSalesState.TxtCustTypeFrom.Text = Trim(DataGrid1.Columns(1).Text)
        End If


        If cnt = 2 Then  '1
            FrmCashSalesState.TbCustTypeTo.Text = Trim(DataGrid1.Columns(0).Text)
        End If
        If cnt = 2 Then  '2
            FrmCashSalesState.TxtCustTypeTo.Text = Trim(DataGrid1.Columns(1).Text)
        End If
